...
def joinFactors(factors: List[Factor]):
    ...
    "*** YOUR CODE HERE ***"
    factors_to_list = list(factors)

    # print("factors",type(factors)) : <class 'dict_values'>
    # print("factors_to_list",type(factors_to_list)) : factors_to_list <class 'list'>
    
    variableDomainsDict = factors_to_list[0].variableDomainsDict()

    unconditioned_vars = set()
    conditioned_vars = set()
    #P(A|B,C) => A is unconditioned variable, B, C are conditioned variable

    for factor in factors_to_list:
